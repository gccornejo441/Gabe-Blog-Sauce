      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div className="mb-4 rounded-lg bg-white px-8 pt-6 pb-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="mb-2 block font-bold text-gray-700">Select font:</label>
              <select
                className="focus:shadow-outline min-w-full appearance-none rounded border py-2 px-3 leading-tight text-gray-700 shadow focus:outline-none"
                value={font}
            ...
            <div className="mb-4">
              <label className="mb-2 block font-bold text-gray-700">Horizontal Layout:</label>
              <select
                className="focus:shadow-outline min-w-full appearance-none rounded border py-2 px-3 leading-tight text-gray-700 shadow focus:outline-none"
