...
export default function SharedModal({
  ...
  return (
    ...
    >
      <div
        className="wide:h-full xl:taller-than-854:h-auto relative flex w-full max-w-7xl items-center"
      ...
      >
        ...
        <div className="w-full overflow-hidden">
          ...
          >
            ...
            >
              {navigation && (
                <ModalNavigation images={images} index={index} changePhotoId={changePhotoId} />
              )}
